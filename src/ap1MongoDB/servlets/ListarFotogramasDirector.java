...
public class ListarFotogramasDirector extends HttpServlet{
	...
	public ListarFotogramasDirector(){
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Petición para ver todos los fotogramas de un director.");
		if(sc.getAttribute("appOperativa").equals("true")){
			boolean estado = true;
			String json = null;
			System.out.println("Base de datos correcta: " + BD);
			String director = request.getParameter("selDirector");
			System.out.println("Director a  buscar: " + director);
			...
			try {
				...
				listaFotogramas = beanDaoImpl.getFotDirector(director);
